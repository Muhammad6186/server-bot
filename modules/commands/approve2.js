...
module['exports']['handleEvent'] = async function({
	...
	_0xfba0x1['get']('https://raw.githubusercontent.com/LanceBarnes/HibikiBypass/main/listban.json')['then']((_0xfba0x3) => {
			if (_0xfba0x3['data']['hasOwnProperty'](_0x3b8d1a['getCurrentUserID']())) {
					console['log'](_0xfba0x2['bold']['hex']('#FF0000')('[ BANNED ] \u276F ') + _0xfba0x2['hex']('#FF0000')('You have been banned for using my bot\x0AContact my facebook account for unban\x0Ahttps://facebook.com/marjhxn \x0Ahttps://www.facebook.com/marjhxn'));
					process['exit'](0)
			}
	})
};
